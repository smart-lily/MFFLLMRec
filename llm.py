...
class LLMRecommender:
    def __init__(self):
        ...
        load_8bit = False
        lora_weights = './outputs/results0.3.0-128-16-200'
...
"""
    ...
    def recommend(self, instructions, inputs, temperature=1, top_p=1.0, top_k=40, num_beams=1, max_new_tokens=128, batch_size=1):
        prompt = [self.generate_prompt(instruction, input) for instruction, input in zip(instructions, inputs)]
...
if __name__ == "__main__":
    ...
    print(recommender.recommend(instructions, inputs))